...
date modified: '星期一, 七月 17日 2023, 12:13:43 中午'
categories:
  - 技术文章
...
![image.png](http://img.puppetdev.top/image/note/bffa74bb56b9925f18c769d383b9c2f8.png)
...
![image.png](http://img.puppetdev.top/image/note/88fbf5d500a90eaf9a952f843b73cf1b.png)

新建好客户端后，也可以在 `+` 中看到，详细的客户端连接命令：

![image.png](http://img.puppetdev.top/image/note/8278272b216a2ca8d57e52d84d391df6.png)
...
![image.png](http://img.puppetdev.top/image/note/c4054891abc54d25e6579229d03ef5bf.png)
...
1. 进入 [官网](https://natapp.cn/)，注册并下载客户端
   ...
   ![image-20220821004721200](http://img.puppetdev.top/image/note/268c59026abae22be927055292d01a4c.png)
...
![image.png](http://img.puppetdev.top/image/note/7965455b08ab7fefa547a61ac6fe418e.png)
...
#### 1.5.3.1 正向SOCKS v5服务器

`./ew -s ssocksd -l 1080`  

#### 1.5.3.2 反弹SOCKS v5服务器
...
#### 1.5.4.2 lcx_listen、lcx_slave的用法
